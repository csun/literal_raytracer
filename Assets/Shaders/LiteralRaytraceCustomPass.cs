...
class LiteralRaytraceCustomPass : CustomPass
{
    ...
    [Tooltip("Causes scenes to slowly fade in as they approach a certain brightness threshold. Once a sample in the scene exceeds this threshold, auto exposure will be used instead.")]
    public float MinBrightnessDivisor = -1;
    ...
    protected override void Execute(CustomPassContext ctx)
    {
        ...
        DrawMaterial.SetFloat("_MinBrightnessDivisor", MinBrightnessDivisor);
